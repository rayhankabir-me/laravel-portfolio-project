...
<div class="col-md-12 p-5">
	...
	<button id="addNewProjectBTn" class="btn btn-danger mb-4 m-0 btn-md">Add New</button>
...
<table id="ProjectDataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
  ...
  <tbody class="projectsTable">
	...
	<div class="project-spninner text-center mt-5">
		<div class="spinner-border text-danger" style="width: 3rem; height: 3rem;" role="status"></div>
	</div>
	<div class="project_error-container text-center mt-2 d-none">
      ...
      <div class="modal-body  text-center">
       <div class="container">
          ...
          <input id="ProjectDesId" type="text" id="" class="form-control mb-3" placeholder="Project Description">
     			...
     			<input id="ProjectImageId" type="text" id="" class="form-control mb-3" placeholder="Project Image Link">
       		</div>
       		<div class="col-md-6">
